...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex space-x-4">
            <select id="dateRange" class="border rounded px-3 py-2 text-sm">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-gray-800">${{ number_format($analytics['total_sales'], 2) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-gray-800">{{ $analytics['total_orders'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-gray-800">${{ number_format($analytics['average_order_value'], 2) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-semibold text-gray-800">{{ $analytics['total_products'] }}</p>
                </div>
            </div>
        </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const salesData = @json($analytics['sales_data']);
        ...
        document.getElementById('dateRange').addEventListener('change', function() {
            ...
            window.location.href = '{{ route("vendor.analytics") }}?days=' + days;
        });
    });
</script>
@endpush
