            ...
            <div class="relative z-10 flex flex-col justify-center px-12 text-white">
                ...
                <div class="space-y-6">
                    ...
                    <p class="text-xl text-white/90 leading-relaxed">
                        For your security, please confirm your password before continuing to access this protected area.
                    </p>
                    <div class="space-y-4 pt-4">
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="w-2 h-2 bg-accent-400 rounded-full"></div>
                            <span class="text-white/90">Protects your personal information</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            <div class="w-2 h-2 bg-accent-400 rounded-full"></div>
                            <span class="text-white/90">Quick and easy verification</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
            <div class="max-w-md w-full space-y-8">
                ...
                <div class="text-center">
                    <h2 class="text-3xl font-bold text-secondary-800 mb-2">Confirm Password</h2>
                    <p class="text-gray-600">For your security, please confirm your password to continue.</p>
                </div>
